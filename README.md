...
### 4-1. 기대효과 및 활용방안
> 시각화 프로젝트
- 코레일 시스템에 대한 개선을 통해 고객들의 편의성을 제고할 수 있다.
- 결과에 따라 마케팅에 적절하게 활용할 수 있다.

> 승객 수 예측 프로젝트
- 코레일의 열차 배차를 개선하거나 코레일 종사 인력을 적절하게 투입하는 등의 해결책을 통해 고객의 편의성을 증대하거나 비용을 줄일 수 있다.
- 특정 열차종, 특정 역 등으로 범위를 좁혀서 더 다양한 수요 예측이 가능하고, 더욱 세부적인 해결책을 도출할 수 있다.
- 승객 수 예측 뿐만 아니라 더욱 다양한 분야에서 시계열 예측이 활용될 수 있다.

### 4-2. 결론 및 제언
- 다양한 시각화 기법을 통해 데이터 자체로도 의미 있는 결과를 쉽게 도출할 수 있다는 것을 보였다.
- 다른 요인들 없이 오직 시간과 시간에 따른 승객 수만 가지고도 여러 모델을 통해 꽤 정확한 예측이 가능하다는 것을 보였다.
- 현 코레일 시스템에 대한 더욱 더 정량화되고 실질적인 해결책을 제시하는데는 실패했다는 것은 아쉬운 점이다.
